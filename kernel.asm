...
[SEGMENT .data]
    strWelcomeMsg   db  "Welcome to MinimalOS! Thanks for using this operating system.", 0x00
	strPrompt		db	"MinimalOS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"MinimalOS - edited by JOSH", 0x00	;OS details
